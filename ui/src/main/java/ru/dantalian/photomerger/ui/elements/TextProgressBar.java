...
/**
 * The standard SWT ProgressBar with setText abilities.
 ...
 * See: <a href='https://github.com/bp-FLN/SWT-Tools/blob/master/src/swt/TextProgressBar.java'>source</a>
 * @author PEH
 * @see ProgressBar
 */
public class TextProgressBar extends Composite {
	...
	private int getStringWidth(String text, FontMetrics fontMetrics) {
		return Double.valueOf(fontMetrics.getAverageCharacterWidth()).intValue() * text.length();
	}
